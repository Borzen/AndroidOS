...
/* SS_BLUETOOTH(changeon.park) 2012.04.10. */
//added for preventing ANR at discovery stop
static dbus_bool_t is_exit_inquiry = FALSE;
...
/* SS_BLUETOOTH(changeon.park) 2012.04.10. */
//added for preventing ANR at discovery stop
		DBG("Set is_exit_inquiry = TRUE");
		is_exit_inquiry = TRUE;
/* SS_BLUETOOTH(changeon.park) End */
...
/* SS_BLUETOOTH(changeon.park) 2012.04.10. */
//added for preventing ANR at discovery stop
	DBG("Set is_exit_inquiry = FALSE");
	is_exit_inquiry = FALSE;
/* SS_BLUETOOTH(changeon.park) End */
...
//added for preventing ANR at discovery stop
	if (is_exit_inquiry)
	{
		DBG("Return due to is_exit_inquiry = TRUE");
		return;
	}
/* SS_BLUETOOTH(changeon.park) End */
