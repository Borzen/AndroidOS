...
void RenderBlock::destroy()
{
    ...
    // __android_log_print(ANDROID_LOG_DEBUG,"Test Logs"," in start RenderBlock::destroy()");
     if(children())
    ...
    RenderBox::destroy();
  //__android_log_print(ANDROID_LOG_DEBUG,"Test Logs"," in leaving RenderBlock::destroy()");
}
